...
![Error40](/images/HYPERVSWSL/huawei.png)
...
![ErrorNotSupport](/images/HYPERVSWSL/errorhuawei.png)
...
To disable Virtual Machine Platform in Control Panel, follow these steps: 
    ...
    * Clear the Virtual Machine Platform check box.

    ![hyperv](/images/HYPERVSWSL/hyper.PNG)
